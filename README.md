...
A pre-execution safety layer for AI agents. Checks planned tool calls before an agent is allowed to act — safe actions run, unsafe actions are blocked, risky actions pause for human approval.
